...
<body>
   ...
   if (!isset($_POST['motDePasse'])) {
    ...
    // Sinon (donc le mot de passe a été envoyé) et est le bon
       ...
       <div class="col"><p>Avez-vous l\'autorisation d\'entrer ? La reponse est : ' . $autorisation_entrer . '</p><p>Le code secret est  : <strong>CRD5-GTFT-CK65-JOPM-V29N-24G1-HH28-LLFV</strong></p><p><a href="liste_travaux.php"><input type="button" class="btn btn-success" value="Retour"></a></p></div></div></div>';
   // Sinon (donc le mot de passe a été envoyé) si le champs du mdp est resté vide
   } elseif ($_POST['motDePasse'] == null) {
       echo '<div class="container"><div class="row my-3">
       <div class="col"><p>Il faut renseigner un Mot De Passe</p><p><a href="codes_nasa.php"><input type="button" class="btn btn-danger" value="Retour"></a></p></div></div></div>';
