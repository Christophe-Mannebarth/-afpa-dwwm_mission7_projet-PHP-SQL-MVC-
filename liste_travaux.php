...
<body>
    ...
    <div class="container">
        ...
        <div class="row mb-3">
            <div class="col">
                <input class="form-control" id="searchInput" type="text" placeholder="Recherchez...">
            </div>
        </div>
        <div class="travauxList">
            <div class="row">
                    ...
                    <div class="card mb-4 mb-lg-0 border-light shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">Mettre en ligne une page web pour donner des
                                informations confidentielles à certaines personnes. Cependant, pour limiter l'accès à
                                cette page, il faudra connaître un mot de passe. 
                                Dans notre cas, les données confidentielles seront les codes d'accès au
                                serveur central de la NASA. Le mot de passe sera <strong>"kangourou"</strong>.
                                Réaliser une page qui n'affiche ces codes secrets que si l'on a rentré le bon mot de
                                passe ?
                            </p>
                ...
                <div class="col-12 col-lg-6">
                    <div class="card mb-4 mb-lg-0 border-light shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">On souhaite avoir, sur la même page et en haut, deux zones de texte :
                                une
                                pour écrire
                ...
                <div class="col-12 col-lg-6">
                    <div class="card mb-4 mb-lg-0 border-light shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text"> Réaliser l'affichage de base d'un blog
                                et des commentaires associés aux billets, et, par la suite, l'améliorer
                                pour créer l'interface de gestion des billets et d'ajout de commentaires.
                ...
                <div class="col-12 col-lg-6">
                    <div class="card mb-4 mb-lg-0 border-light shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text"> 
                                Vous avez forcément déjà vu un espace membres, même si le site web 
                                ne l'appelle pas exactement comme cela.
                            ...
                            <ul>
                                ...
                                <li>
                                    <p>On peut ensuite ajouter d'autres pages.</p>
                                </li>
                                <li>
                                    <p>Une page pour l'admin et une pour le membre.</p>
                                </li>
                                <li>
                                    <p>Cependant, il faut au minimum avoir créé les 3 pages de base.</p>
                                </li>
                            </ul>
                    ...
                    <div class="card mb-4 mb-lg-0 border-light shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">
                                ...
                                Contrôleur. C'est celui que nous allons découvrir maintenant.
                                Le pattern MVC permet de bien organiser son code source. Il va vous aider à savoir quels
                                fichiers créer, mais surtout à définir leur rôle. Le but de MVC est justement de séparer
                                la logique du code en trois parties que l'on retrouve dans des fichiers distincts.
                            <ul>
                                <li>
                                    <p><b>Modèle :</b> cette partie gère les données de votre site. Son rôle est d'aller
                                        récupérer les informations « brutes » dans la base de données, de les organiser
                                        et de les assembler pour qu'elles puissent ensuite être traitées par le
                                        contrôleur. On y trouve donc entre autres les requêtes SQL.</p>
                                </li>
                                <li>
                                    <p><b>Vue :</b> cette partie se concentre sur l'affichage. Elle ne fait presque
                                        aucun calcul et se contente de récupérer des variables pour savoir ce qu'elle
                                        doit afficher. On y trouve essentiellement du code HTML mais aussi quelques
                                        boucles et conditions PHP très simples, pour afficher par exemple une liste de
                                        messages.</p>
                                </li>
                                <li>
                                    <p><b>Contrôleur :</b> cette partie gère la logique du code qui prend des décisions.
                                        ...
                                        PHP. C'est notamment lui qui détermine si le visiteur a le droit de voir la page
